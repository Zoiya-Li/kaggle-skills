...
Read `../shared-references/operational-hygiene.md` before updating long-lived notes, handling user-provided credentials, or concluding that a deployment is blocked or ready.
