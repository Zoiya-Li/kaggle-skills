...
Read `../shared-references/operational-hygiene.md` before logging progress, handling remote credentials, or promoting a branch from hypothesis to execution priority.
