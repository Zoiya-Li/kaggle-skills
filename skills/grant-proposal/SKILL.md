...
- Search for **funded projects** in the same area via `WebSearch`, then open official program pages with `WebFetch`:
  - KAKENHI → KAKEN database (https://kaken.nii.ac.jp/)
  - NSF → NSF Award Search (https://www.nsf.gov/awardsearch/)
  - NSFC → NSFC funded projects
  - Other agencies → broader web discovery, but prefer official grant databases and agency pages
